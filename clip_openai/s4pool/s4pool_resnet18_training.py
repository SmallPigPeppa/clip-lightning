...
parser.add_argument('-data', metavar='DIR',
                    help='path to dataset', default='/home/vivekm/imagenet')
...
def main_worker(gpu, ngpus_per_node, args):
   ...
   #     print(name)
    ...
    def conv_s4pool(self, input):
            (shift1, shift2) = block_shift[self.name[7:13]]
    ...
    train_dataset = datasets.ImageNet("/home/vivekm/imagenet", split='train', transform=transforms.Compose([
...
#            transforms.RandomCrop(225, padding=1, pad_if_needed=True, fill=(128, 128, 128), padding_mode='constant'),
    ...
    val_loader = torch.utils.data.DataLoader(
        datasets.ImageNet("/home/vivekm/imagenet", split='val', transform=transforms.Compose([
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        block_shift['conv1'] = (np.random.randint(2), np.random.randint(2))
        block_shift['layer2'] = (np.random.randint(2), np.random.randint(2))
        block_shift['layer3'] = (np.random.randint(2), np.random.randint(2))
        block_shift['layer4'] = (np.random.randint(2), np.random.randint(2))
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            block_shift['conv1'] = shifts[i % 4]
            block_shift['layer2'] = shifts[(i+1) % 4]
            block_shift['layer3'] = shifts[(i+2) % 4]
            block_shift['layer4'] = shifts[(i+3) % 4]
