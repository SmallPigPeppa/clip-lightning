...
run_training() {
  ...
  python ${METHOD_MAP[$method]} fit \
    ...
    --model.download_root ./ \
    --model.old_checkpoint_path ckpt/flickr30k-1024/vanilla-lr-8.6e-6-lr_text-1.3e-4.ckpt \
    ...
    --model_checkpoint.filename ${dataset_name}-1024/task2-${method}-lr-${lr}-lr_text-${lr_text}
}
