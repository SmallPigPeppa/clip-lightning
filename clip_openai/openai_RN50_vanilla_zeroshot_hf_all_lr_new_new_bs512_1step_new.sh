...
for DATASET_NAME in "${DATASETS[@]}"; do
  ...
  python cli_distill_zeroshot_lora_best_new.py fit \
    ...
    --model_checkpoint.filename ${DATASET_NAME}-512/dislora-new
...
#    --model_checkpoint.dirpath ckpt \
#    --model_checkpoint.save_weights_only True \
#    --model_checkpoint.filename ${DATASET_NAME}-512/dislora


#
#  python cli_vanilla_zeroshot_lora_best.py fit \
#    --data.num_tasks 1 \
#    --data.current_task 0 \
#    --data.max_length 77 \
#    --data.batch_size 128 \
...
#    --model_checkpoint.dirpath ckpt \
#    --model_checkpoint.save_weights_only True \
#    --model_checkpoint.filename ${DATASET_NAME}-512/lora-best
#
...
#    --model_checkpoint.dirpath ckpt \
#    --model_checkpoint.save_weights_only True \
#    --model_checkpoint.filename ${DATASET_NAME}-512/lora
###
##
##
...
#    --model_checkpoint.dirpath ckpt \
#    --model_checkpoint.save_weights_only True \
#    --model_checkpoint.filename ${DATASET_NAME}-512/vanilla

#  python cli_distill_zeroshot_new.py fit \
#    --data.num_tasks 1 \
#    --data.current_task 0 \
#    --data.max_length 77 \
#    --data.batch_size 128 \
...
#    --model_checkpoint.dirpath ckpt \
#    --model_checkpoint.save_weights_only True \
#    --model_checkpoint.filename ${DATASET_NAME}-512/distill-new
