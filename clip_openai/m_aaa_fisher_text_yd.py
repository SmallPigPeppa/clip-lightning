...
from zero_shot.zero_shot_metadata_imagenet import IMAGENET_CLASSNAMES

from zero_shot.zero_shot_metadata_imagenet import MY_TEMPLATE as OPENAI_IMAGENET_TEMPLATES
